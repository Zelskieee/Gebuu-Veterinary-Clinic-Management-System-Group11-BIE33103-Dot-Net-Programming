<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WithBackBtn.Master" AutoEventWireup="true" CodeBehind="ModifyAppointment.aspx.cs" Inherits="Gebuu.aspx_Appointment.ModifyAppointment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <div class="box">
                <asp:Label ID="pagetitle" runat="server" style="font-weight: 700; font-size: xx-large; text-align: center; display: block;">Update Appointment</asp:Label>
